...
class Corte extends Component{
        ...
        firebase.auth().onAuthStateChanged(user=>{
            if(user){
                if(this.state.dato!==""&&this.state.precio!==""){
                    ...
                    firebase.database().ref("Corte").push(corte)
                    .then(res=>{
    ...
    elimina(id){
        const itemref=firebase.database().ref(`Corte/${id}`);
        itemref.remove();
    }
    modifica(id,nombre){
        this.setState({
    ...
    actualiza(){
        ...
        db.ref('Corte/'+this.state.id).update({
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="box box-info">
                            <div className="box-header with-border">
                                <h3 className="box-title">Agregar Terminado</h3>
                            </div>
            
                            <form className="form-horizontal">
                                <div className="box-body">
                                <div className="form-group">
                                    <label htmlFor="inputEmail3" className="col-sm-2 control-label">Terminado</label>
            ...
            <div style={{display:this.state.estadoForm}}> 
                <div className="col-md-6" >
                    <div className="box box-success box-solid">
                        <div className="box-header with-border">
                            <h3 className="box-title">Modifica Terminado</h3>
