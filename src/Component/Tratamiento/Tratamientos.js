...
class Tratamiento extends Component{
        ...
        firebase.auth().onAuthStateChanged(user=>{
            if(user){
                if(this.state.dato!==""&&this.state.precio!==""){
                    ...
                    firebase.database().ref("Tratamiento").push(Tratamiento)
                    .then(res=>{
    ...
    elimina(id){
        const itemref=firebase.database().ref(`Tratamiento/${id}`);
        itemref.remove();
    }
    modifica(id,nombre){
        this.setState({
    ...
    actualiza(){
        ...
        db.ref('Tratamiento/'+this.state.id).update({
                    ...
                    <div className="col-md-6">
                        ...
                        <div className="box box-info">
                            <div className="box-header with-border">
                                <h3 className="box-title">Agregar Tratamiento</h3>
                            </div>
            ...
            <div style={{display:this.state.estadoForm}}> 
                <div className="col-md-6" >
                    <div className="box box-success box-solid">
                        <div className="box-header with-border">
                            <h3 className="box-title">Modificar Tratamiento</h3>
